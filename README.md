...
<details>
<summary>All 1,374 function similarity scores (95.39% average)</summary>

| Compilation unit | Function | Address | Similarity |
| --- | --- | --- | ---: |
| `auto.c` | `visit_the_cinema` | `0x403E50` | 94.59% |
...
| `brains.c` | `AnimateScrambleWalk` | `0x407750` | 96.23% |
| `brains.c` | `PlayScrambleHangarScene` | `0x4079C0` | 89.83% |
| `brains.c` | `DrawScrambleActor` | `0x407C90` | 66.67% |
| `brains.c` | `ConfigureScrambleActor` | `0x407D90` | 100.00% |
| `brains.c` | `DrawScrambleFrame` | `0x407E10` | 96.55% |
...
| `cockpt.c` | `vdu_polygon` | `0x413DA0` | 84.43% |
...
| `cockpt.c` | `draw_nav_pointer` | `0x4168C0` | 85.82% |
...
| `disk.c` | `FetchDiskPacketRetrying` | `0x41D2E0` | 83.52% |
...
| `eventmgr.c` | `ReleaseInputEvent` | `0x435760` | 55.56% |
...
| `killbrd.c` | `DecodeShapeFrame` | `0x440960` | 85.20% |
...
| `mono.c` | `print_subtitle` | `0x403920` | 48.48% |
...
| `music.c` | `show_target_disp` | `0x42DB90` | 93.72% |
...
| `nav.c` | `InflightComputer` | `0x40E480` | 94.96% |
...
| `screen.c` | `IsPushedPacketHandle` | `0x42F9E0` | 90.91% |
...
| `sound.c` | `DrawLaunchDoorFrame` | `0x42B9A0` | 97.30% |
...
| `sound.c` | `LoadInstallDat` | `0x42C660` | 54.29% |
...
| `spc.c` | `CalibrateJoystickInteractive` | `0x4102B0` | 67.21% |
...
| `spc.c` | `house_keep_objects` | `0x412430` | 94.38% |
