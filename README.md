...
After training it reaches the Tiger's Claw rec room, renders the original fixed-region
Shotglass, pilot, constellation, and menu animations, and uses the recovered palette transition
when entering the room. Packet-driven scenes support conditional dialogue, player-name
substitution, animated faces and mouths, conversation close-ups, briefing and podium long shots,
debriefing and dismissal shots, medal ceremonies, and funeral establishing shots. The
pilot-score chalkboard, barracks, training, and mission-hangar routes are also available.

Specialized briefing-map updates, the complete funeral sequence, generic scripted scene
commands, campaign save/load slots, full mission briefings, and later campaign progression
remain incomplete. Space flight is playable but still has substantial gameplay and presentation
code left to reconstruct.
...
<details>
<summary>All 1,140 function similarity scores (91.40% average)</summary>
...
| `barracks.c` | `StepPaletteTransition` | `0x41C510` | 89.61% |
...
| `brains.c` | `imperial_formation` | `0x409D60` | 91.87% |
...
| `brains.c` | `mine_intelligence` | `0x40B3A0` | 91.67% |
...
| `disk.c` | `MoveMenuPointerFromKeyboard` | `0x41DC70` | 78.48% |
...
| `geom.c` | `ComputeVectorDelta` | `0x418680` | 86.67% |
...
| `gr.c` | `DrawSpriteTransformed` | `0x440FE0` | 20.95% |
...
| `gr.c` | `CaptureSpriteBackground` | `0x441450` | 51.36% |
...
| `logic.c` | `evaluate_damage` | `0x423C00` | 84.13% |
...
| `pilot.cpp` | `InitializeTrainSimHighScores` | `0x425F40` | 88.89% |
...
| `screen.c` | `UpdateInputDeviceTransitions` | `0x430710` | 83.33% |
| `screen.c` | `PollJoystickButtonEvents` | `0x430840` | 47.17% |
| `screen.c` | `PollMenuInputDevices` | `0x430920` | 59.60% |
...
| `screens.c` | `SceneDirector` | `0x438C00` | 74.32% |
