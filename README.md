...
<details>
<summary>All 1,472 function similarity scores (98.41% average)</summary>
...
| `brains.c` | `imperial_formation` | `0x409D60` | 98.40% |
...
| `disk.c` | `sort_viable_target_list` | `0x41E860` | 89.13% |
...
| `eventmgr.c` | `sort_object_depth` | `0x436460` | 100.00% |
| `eventmgr.c` | `draw_sorted_objects_to_buffer` | `0x436520` | 90.28% |
...
| `geom.c` | `check_for_collision` | `0x4199C0` | 94.34% |
...
| `geom.c` | `transform_objects_to_your_view` | `0x41A1D0` | 96.14% |
...
| `gr.c` | `DrawFontGlyph` | `0x441150` | 84.05% |
| `gr.c` | `MarkActivePaletteEntries` | `0x441370` | 92.31% |
...
| `hudmsg.c` | `drop_player_mine` | `0x42ABD0` | 91.67% |
...
| `killbrd.c` | `ReadPacketSectionData` | `0x440840` | 90.91% |
...
| `logic.c` | `replenish_shields` | `0x421780` | 92.73% |
...
| `logic.c` | `LoadOriginFxDrivers` | `0x421B10` | 97.93% |
...
| `main.c` | `player_input` | `0x4285D0` | 82.73% |
...
| `music.c` | `DecompressPacketSection` | `0x42D880` | 95.50% |
...
| `pilot.cpp` | `UpdateTrainSimHighScores` | `0x426820` | 100.00% |
| `pilot.cpp` | `ShowTrainSimHighScores` | `0x4268E0` | 96.62% |
| `pilot.cpp` | `LoadTrainSimOpponentShape` | `0x426C50` | 100.00% |
| `pilot.cpp` | `SelectTrainSimMission` | `0x426C70` | 97.03% |
...
| `screens.c` | `ParseTests` | `0x438160` | 95.37% |
...
| `spc.c` | `SetFleetOverviewView` | `0x410740` | 100.00% |
...
| `winmain.c` | `MainWindowProc` | `0x402530` | 93.55% |
