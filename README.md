...
<details>
<summary>All 1,465 function similarity scores (96.75% average)</summary>
...
| `music.c` | `OpenPacketSection` | `0x42D730` | 87.85% |
...
| `pilot.cpp` | `UpdateTrainSimHighScores` | `0x426820` | 91.53% |
